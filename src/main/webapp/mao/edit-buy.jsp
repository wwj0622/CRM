...
<body>
	...
	<div  id="app">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" v-model="buyDetail.bdcount" placeholder="" id="count" >
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>产品价格：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" v-model="buyDetail.bdprice" placeholder="" id="price">
			</div>
		</div>
		<div class="row cl">
	...
	methods:{
		selectSupplier:function(){
			...
			$.ajax({
	            ...
	            success: function (response) {
	            	...
	            	_thiss.partsList = response.data;
		...
		a:function(){
	        ...
	        $.ajax({
	            ...
	            dataType: "json",
	            success: function (response) {
	            	_this.buyDetail = response.data1;
